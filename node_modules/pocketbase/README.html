...
<span class="nx">require</span><span class="p">(</span><span class="s1">&#39;cross-fetch/polyfill&#39;</span><span class="p">);</span>
</pre></div></p>
</blockquote>
<hr />
<blockquote>
...
I recommend <a href="https://github.com/EventSource/eventsource">EventSource/eventsource</a>:
<div class="highlight"><pre><span class="c1">// npm install eventsource --save</span>
<span class="nx">global</span><span class="p">.</span><span class="nx">EventSource</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;eventsource&#39;</span><span class="p">);</span>
</pre></div></p>
</blockquote>
...
<blockquote>
<p>More detailed API docs and copy-paste examples could be found in the <a href="https://pocketbase.io/docs/api-authentication">API documentation for each service</a>.</p>
</blockquote>
...
<div class="highlight"><pre><span class="nx">ClientResponseError</span> <span class="p">{</span>
    ...
    <span class="nx">data</span><span class="o">:</span>          <span class="p">{</span> <span class="p">...</span> <span class="p">},</span>    <span class="c1">// the API JSON error response</span>
...
<div class="highlight"><pre><span class="nx">BaseAuthStore</span> <span class="p">{</span>
    ...
    <span class="nx">model</span><span class="o">:</span>   <span class="nx">User</span><span class="o">|</span><span class="nx">Admin</span><span class="o">|</span><span class="kc">null</span> <span class="c1">// the authenticated User or Admin model</span>
    ...
    <span class="nx">clear</span><span class="p">()</span>            <span class="c1">// &quot;logout&quot; the authenticated User or Admin</span>
...
<p>To <em>&ldquo;logout&rdquo;</em> an authenticated user or admin, you can just call <code>pb.authStore.clear()</code>.</p>
...
<span class="nx">pb</span><span class="p">.</span><span class="nx">collection</span><span class="p">(</span><span class="s1">&#39;tasks&#39;</span><span class="p">).</span><span class="nx">getList</span><span class="o">&lt;</span><span class="nx">Task</span><span class="o">&gt;</span><span class="p">(</span><span class="s2">&quot;RECORD_ID&quot;</span><span class="p">)</span> <span class="c1">// -&gt; results in Promise&lt;ListResult&lt;Task&gt;&gt;</span>
...
<span class="nx">pb</span><span class="p">.</span><span class="nx">beforeSend</span> <span class="o">=</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">url</span><span class="p">,</span> <span class="nx">reqConfig</span><span class="p">)</span> <span class="p">{</span>
    <span class="c1">// For list of the possible reqConfig properties check</span>
    <span class="c1">// https://developer.mozilla.org/en-US/docs/Web/API/fetch#options</span>
    <span class="nx">reqConfig</span><span class="p">.</span><span class="nx">headers</span> <span class="o">=</span> <span class="nb">Object</span><span class="p">.</span><span class="nx">assign</span><span class="p">({},</span> <span class="nx">reqConfig</span><span class="p">.</span><span class="nx">headers</span><span class="p">,</span> <span class="p">{</span>
        <span class="s1">&#39;X-Custom-Header&#39;</span><span class="o">:</span> <span class="s1">&#39;example&#39;</span><span class="p">,</span>
    <span class="p">});</span>

    <span class="k">return</span> <span class="nx">reqConfig</span><span class="p">;</span>
<span class="p">};</span>
</pre></div></p>
</li>
<li>
...
<span class="kr">export</span> <span class="nx">async</span> <span class="kd">function</span> <span class="nx">handle</span><span class="p">({</span> <span class="nx">event</span><span class="p">,</span> <span class="nx">resolve</span> <span class="p">})</span> <span class="p">{</span>
    ...
    <span class="k">try</span> <span class="p">{</span>
        <span class="c1">// get an up-to-date auth store state by veryfing and refreshing the loaded auth model (if any)</span>
    ...
    <span class="nx">response</span><span class="p">.</span><span class="nx">headers</span><span class="p">.</span><span class="nx">set</span><span class="p">(</span><span class="s1">&#39;set-cookie&#39;</span><span class="p">,</span> <span class="nx">event</span><span class="p">.</span><span class="nx">locals</span><span class="p">.</span><span class="nx">pb</span><span class="p">.</span><span class="nx">authStore</span><span class="p">.</span><span class="nx">exportToCookie</span><span class="p">());</span>
...
<span class="c1">//</span>
<span class="c1">// creates a `POST /login` server-side endpoint</span>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">defineNuxtPlugin</span><span class="p">(</span><span class="nx">async</span> <span class="p">(</span><span class="nx">nuxtApp</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
  <span class="kr">const</span> <span class="nx">pb</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">PocketBase</span><span class="p">(</span><span class="s1">&#39;http://127.0.0.1:8090&#39;</span><span class="p">);</span>

  <span class="c1">// load the store data from the request cookie string</span>
  <span class="nx">pb</span><span class="p">.</span><span class="nx">authStore</span><span class="p">.</span><span class="nx">loadFromCookie</span><span class="p">(</span><span class="nx">nuxtApp</span><span class="p">.</span><span class="nx">ssrContext</span><span class="o">?</span><span class="p">.</span><span class="nx">event</span><span class="o">?</span><span class="p">.</span><span class="nx">req</span><span class="o">?</span><span class="p">.</span><span class="nx">headers</span><span class="o">?</span><span class="p">.</span><span class="nx">cookie</span> <span class="o">||</span> <span class="s1">&#39;&#39;</span><span class="p">);</span>
  ...
  <span class="nx">pb</span><span class="p">.</span><span class="nx">authStore</span><span class="p">.</span><span class="nx">onChange</span><span class="p">(()</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="k">if</span> <span class="p">(</span><span class="nx">nuxtApp</span><span class="p">.</span><span class="nx">ssrContext</span><span class="o">?</span><span class="p">.</span><span class="nx">event</span><span class="o">?</span><span class="p">.</span><span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
      <span class="nx">nuxtApp</span><span class="p">.</span><span class="nx">ssrContext</span><span class="p">.</span><span class="nx">event</span><span class="p">.</span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;set-cookie&#39;</span><span class="p">,</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">authStore</span><span class="p">.</span><span class="nx">exportToCookie</span><span class="p">());</span>
    <span class="p">}</span>
  <span class="p">});</span>
...
<span class="p">&lt;</span><span class="nt">script</span><span class="p">&gt;</span>
  <span class="kr">export</span> <span class="k">default</span> <span class="p">{</span>
    <span class="nx">async</span> <span class="nx">asyncData</span><span class="p">({</span> <span class="nx">$pocketbase</span> <span class="p">})</span> <span class="p">{</span>
      <span class="c1">// fetch and return all &quot;example&quot; records...</span>
      <span class="kr">const</span> <span class="nx">items</span> <span class="o">=</span> <span class="nx">await</span> <span class="nx">$pocketbase</span><span class="p">.</span><span class="nx">records</span><span class="p">.</span><span class="nx">getFullList</span><span class="p">(</span><span class="s1">&#39;example&#39;</span><span class="p">);</span>
...
<tr>
<td align="left"><code>pb.getFileUrl(record, filename, reqConfig = {})</code></td>
<td align="left">Builds and returns an absolute record file url for the provided filename.</td>
</tr>
<tr>
...
<span class="err">🔓</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">collection</span><span class="p">(</span><span class="nx">collectionIdOrName</span><span class="p">).</span><span class="nx">getFullList</span><span class="p">(</span><span class="nx">batch</span> <span class="o">=</span> <span class="mi">200</span><span class="p">,</span> <span class="nx">queryParams</span> <span class="o">=</span> <span class="p">{});</span>
...
<span class="err">🔐</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">admins</span><span class="p">.</span><span class="nx">getFullList</span><span class="p">(</span><span class="nx">batch</span> <span class="o">=</span> <span class="mi">200</span><span class="p">,</span> <span class="nx">queryParams</span> <span class="o">=</span> <span class="p">{});</span>
...
<span class="err">🔐</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">collections</span><span class="p">.</span><span class="nx">getFullList</span><span class="p">(</span><span class="nx">batch</span> <span class="o">=</span> <span class="mi">200</span><span class="p">,</span> <span class="nx">queryParams</span> <span class="o">=</span> <span class="p">{});</span>
