let parseUrl,RemakeStore,capture,doesPageExist;_896‍.x([["getParams",()=>getParams]]);_896‍.w("parseurl",[["default",["parseUrl"],function(v){parseUrl=v}]]);_896‍.w("../lib/remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);_896‍.w("./async-utils",[["capture",["capture"],function(v){capture=v}]]);_896‍.w("./page-utils",[["doesPageExist",["doesPageExist"],function(v){doesPageExist=v}]]);const pathMatch = require("path-match")({});
