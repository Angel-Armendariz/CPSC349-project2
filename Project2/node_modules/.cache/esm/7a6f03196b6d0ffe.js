let isValidCommand,showError,callSaveFunction,triggerWatchAttributes,executeCommandOnMultipleElements,getTargetsForCommand,forEachAttr;_6b6‍.x([["getTargetElemsForKeyName",()=>getTargetElemsForKeyName],["setValueForKeyName",()=>setValueForKeyName],["getValueForKeyName",()=>getValueForKeyName],["getClosestElemWithKey",()=>getClosestElemWithKey],["getValueForClosestKey",()=>getValueForClosestKey],["setValueForClosestKey",()=>setValueForClosestKey],["getKeyNamesFromElem",()=>getKeyNamesFromElem]]);_6b6‍.w("../common/get-valid-element-properties",[["isValidCommand",["isValidCommand"],function(v){isValidCommand=v}]]);_6b6‍.w("../common/show-error",[["showError",["showError"],function(v){showError=v}]]);_6b6‍.w("../inputjs/onSave",[["callSaveFunction",["callSaveFunction"],function(v){callSaveFunction=v}]]);_6b6‍.w("./commandAndWatchHelpers",[["triggerWatchAttributes",["triggerWatchAttributes"],function(v){triggerWatchAttributes=v}],["executeCommandOnMultipleElements",["executeCommandOnMultipleElements"],function(v){executeCommandOnMultipleElements=v}],["getTargetsForCommand",["getTargetsForCommand"],function(v){getTargetsForCommand=v}]]);_6b6‍.w("../hummingbird/lib/dom",[["forEachAttr",["forEachAttr"],function(v){forEachAttr=v}]]);
...
function _valueForKeyName({ method, elem, keyName, value = "" }) {
  ...
  if (!normalKeyExists && !temporaryKeyExists) {
    _6b6‍.a("showError",showError)("You can't set a key name to a value if the key doesn't exist on the element yet");
    return;
  }

  let attrName = normalKeyExists ? "key:" + dashCaseKeyName : "temporary:key:" + dashCaseKeyName;
  let attrValue = elem.getAttribute(attrName);
  let hasValidCommand = _6b6‍.a("isValidCommand",isValidCommand)({ commandName: attrValue, includingSearchCommand: true });
  ...
  if (!hasValidCommand) {
    ...
    let targets = _6b6‍.a("getTargetsForCommand",getTargetsForCommand)({ elem, dashCaseKeyName, attrName, attrValue });
    targetElems = targets.targetElems;
    targetAttr = targets.targetAttr;
    if (method === "set") {
      _6b6‍.a("executeCommandOnMultipleElements",executeCommandOnMultipleElements)({ targetElems, targetAttr, value, method });
    } else {
      return _6b6‍.a("executeCommandOnMultipleElements",executeCommandOnMultipleElements)({ targetElems, targetAttr, value, method });
    }
  }
  ...
  if (method === "set") {
    ...
    if (!settingTemporaryKey) {
      _6b6‍.a("callSaveFunction",callSaveFunction)(elem);
    }
    ...
    _6b6‍.a("triggerWatchAttributes",triggerWatchAttributes)({ elem, dashCaseKeyName, value, targetElems });
  }
}
...
// returns keynames with dashes in them: ["example-key", "another-example"]
  ...
  _6b6‍.a("forEachAttr",forEachAttr)(elem, attrName => {
