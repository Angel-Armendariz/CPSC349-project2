_78d‍.x([["forEachAncestorMatch",()=>forEachAncestorMatch],["forEachMatchingElem",()=>forEachMatchingElem],["forEachNestedElem",()=>forEachNestedElem],["findNestedElem",()=>findNestedElem],["getParents",()=>getParents],["findNearest",()=>findNearest],["forEachAttr",()=>forEachAttr],["getElementOffset",()=>getElementOffset],["onAttributeEvent",()=>onAttributeEvent]]);// TRAVERSING & ASSEMBLING DOM UTILS
...
// searches parent element and all children to see if they match a selector
  ...
  childMatches.forEach(childMatch => {
    callback(childMatch);
       ...
       function forEachNestedElem(elem, callback) {
  callback(elem);
  ...
  for (let i = 0, l = elem.children.length; i < l; i++) {
    forEachNestedElem(elem.children[i], callback);
       ...
       function findNestedElem(elem, testFunc) {
  let firstMatch;
