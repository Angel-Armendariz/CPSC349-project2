let forEachAttr,getValueForKeyName;_802‍.x([["createDataObjectFromElement",()=>createDataObjectFromElement],["addDataFromElementToDataObject",()=>addDataFromElementToDataObject]]);_802‍.w("../hummingbird/lib/dom",[["forEachAttr",["forEachAttr"],function(v){forEachAttr=v}]]);_802‍.w("../data-utilities",[["getValueForKeyName",["getValueForKeyName"],function(v){getValueForKeyName=v}]]);
...
function getSaveDataFromElement(elem) {
  ...
  _802‍.a("forEachAttr",forEachAttr)(elem, attrName => {
    if (attrName.indexOf(keyPrefix) === 0) {
      let keyName = attrName.substring(keyPrefix.length);
      let camelCaseKeyName = camelCase(keyName);
      data[camelCaseKeyName] = _802‍.a("getValueForKeyName",getValueForKeyName)({ elem, keyName });
    }
  });
