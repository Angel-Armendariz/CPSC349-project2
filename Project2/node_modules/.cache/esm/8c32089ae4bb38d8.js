let getLongUniqueId,getUserData,capture,mkdirpAsync,getDirForUpload,RemakeStore;_e4b‍.x([["initApiUpload",()=>initApiUpload]]);_e4b‍.w("./get-unique-id",[["getLongUniqueId",["getLongUniqueId"],function(v){getLongUniqueId=v}]]);_e4b‍.w("./user-data",[["getUserData",["getUserData"],function(v){getUserData=v}]]);_e4b‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}],["mkdirpAsync",["mkdirpAsync"],function(v){mkdirpAsync=v}]]);_e4b‍.w("../utils/directory-helpers",[["getDirForUpload",["getDirForUpload"],function(v){getDirForUpload=v}]]);_e4b‍.w("./remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);const path = require("upath");
