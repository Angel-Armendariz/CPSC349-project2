let initApiNew,initApiSave,initApiUpload,initRenderedRoutes,initUserAccounts,initServiceRoutes,getParams,showConsoleSuccess,capture,setEnvironmentVariables,getCacheBustString,getAvailablePort,RemakeStore;_b21‍.w("./lib/init-api-new",[["initApiNew",["initApiNew"],function(v){initApiNew=v}]]);_b21‍.w("./lib/init-api-save",[["initApiSave",["initApiSave"],function(v){initApiSave=v}]]);_b21‍.w("./lib/init-api-upload",[["initApiUpload",["initApiUpload"],function(v){initApiUpload=v}]]);_b21‍.w("./lib/init-rendered-routes",[["initRenderedRoutes",["initRenderedRoutes"],function(v){initRenderedRoutes=v}]]);_b21‍.w("./lib/init-user-accounts",[["initUserAccounts",["initUserAccounts"],function(v){initUserAccounts=v}]]);_b21‍.w("./lib/init-service-routes",[["initServiceRoutes",["initServiceRoutes"],function(v){initServiceRoutes=v}]]);_b21‍.w("./utils/get-params",[["getParams",["getParams"],function(v){getParams=v}]]);_b21‍.w("./utils/console-utils",[["showConsoleSuccess",["showConsoleSuccess"],function(v){showConsoleSuccess=v}]]);_b21‍.w("./utils/async-utils",[["capture",["capture"],function(v){capture=v}]]);_b21‍.w("./utils/setup-env",[["setEnvironmentVariables",["setEnvironmentVariables"],function(v){setEnvironmentVariables=v}]]);_b21‍.w("./utils/remake-app-data",[["getCacheBustString",["getCacheBustString"],function(v){getCacheBustString=v}]]);_b21‍.w("./utils/get-available-port",[["default",["getAvailablePort"],function(v){getAvailablePort=v}]]);_b21‍.w("./lib/remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);const express = require("express");
