let getLongUniqueId,getUserData,capture,mkdirpAsync,getDirForUpload,RemakeStore;_fe2‍.x([["initApiUpload",()=>initApiUpload]]);_fe2‍.w("./get-unique-id",[["getLongUniqueId",["getLongUniqueId"],function(v){getLongUniqueId=v}]]);_fe2‍.w("./user-data",[["getUserData",["getUserData"],function(v){getUserData=v}]]);_fe2‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}],["mkdirpAsync",["mkdirpAsync"],function(v){mkdirpAsync=v}]]);_fe2‍.w("../utils/directory-helpers",[["getDirForUpload",["getDirForUpload"],function(v){getDirForUpload=v}]]);_fe2‍.w("./remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);const path = require("upath");
