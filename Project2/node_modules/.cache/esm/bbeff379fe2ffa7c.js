let showConsoleError,capture,mkdirpAsync,getBootstrapData,getDirForUserData;_fe2‍.x([["createUserData",()=>createUserData],["getUserData",()=>getUserData],["setUserData",()=>setUserData]]);_fe2‍.w("../utils/console-utils",[["showConsoleError",["showConsoleError"],function(v){showConsoleError=v}]]);_fe2‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}],["mkdirpAsync",["mkdirpAsync"],function(v){mkdirpAsync=v}]]);_fe2‍.w("../utils/get-bootstrap-data",[["getBootstrapData",["getBootstrapData"],function(v){getBootstrapData=v}]]);_fe2‍.w("../utils/directory-helpers",[["getDirForUserData",["getDirForUserData"],function(v){getDirForUserData=v}]]);const jsonfile = require("jsonfile");
