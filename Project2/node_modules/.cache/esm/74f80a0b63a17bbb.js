let forEachAttr,getValueForKeyName;_63a‍.x([["createDataObjectFromElement",()=>createDataObjectFromElement],["addDataFromElementToDataObject",()=>addDataFromElementToDataObject]]);_63a‍.w("../hummingbird/lib/dom",[["forEachAttr",["forEachAttr"],function(v){forEachAttr=v}]]);_63a‍.w("../data-utilities",[["getValueForKeyName",["getValueForKeyName"],function(v){getValueForKeyName=v}]]);
...
function getSaveDataFromElement(elem) {
  ...
  _63a‍.a("forEachAttr",forEachAttr)(elem, attrName => {
    if (attrName.indexOf(keyPrefix) === 0) {
      let keyName = attrName.substring(keyPrefix.length);
      let camelCaseKeyName = camelCase(keyName);
      data[camelCaseKeyName] = _63a‍.a("getValueForKeyName",getValueForKeyName)({ elem, keyName });
    }
  });
