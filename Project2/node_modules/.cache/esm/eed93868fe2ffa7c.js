let capture,readdirAsync,getPageTemplate,getDataForPage,getPageHtml,getRootAppsPageHtml,getUserData,parseUrl,getParams,routeUtils,RemakeStore;_fe2‍.x([["initRenderedRoutes",()=>initRenderedRoutes]]);_fe2‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}],["readdirAsync",["readdirAsync"],function(v){readdirAsync=v}]]);_fe2‍.w("../utils/page-utils",[["getPageTemplate",["getPageTemplate"],function(v){getPageTemplate=v}],["getDataForPage",["getDataForPage"],function(v){getDataForPage=v}],["getPageHtml",["getPageHtml"],function(v){getPageHtml=v}],["getRootAppsPageHtml",["getRootAppsPageHtml"],function(v){getRootAppsPageHtml=v}]]);_fe2‍.w("./user-data",[["getUserData",["getUserData"],function(v){getUserData=v}]]);_fe2‍.w("parseurl",[["default",["parseUrl"],function(v){parseUrl=v}]]);_fe2‍.w("../utils/get-params",[["getParams",["getParams"],function(v){getParams=v}]]);_fe2‍.w("../utils/route-utils",[["default",["routeUtils"],function(v){routeUtils=v}]]);_fe2‍.w("./remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);const path = require("upath");
