let getDirForPageTemplate,getDirForRootApp,getDirForLayoutTemplate,capture,readFileAsync,readdirAsync,statAsync,forInLoopRegex,getHandlebarsContext,processData,addRemakeAppStatusToPage,getPartialsAsInlinePartials,getGlobalData,getHtmlWithUniqueIds,RemakeStore;_c0d‍.x([["getRootAppsPageHtml",()=>getRootAppsPageHtml],["getPageTemplate",()=>getPageTemplate],["getDataForPage",()=>getDataForPage],["getPageHtml",()=>getPageHtml],["doesPageExist",()=>doesPageExist]]);_c0d‍.w("./directory-helpers",[["getDirForPageTemplate",["getDirForPageTemplate"],function(v){getDirForPageTemplate=v}],["getDirForRootApp",["getDirForRootApp"],function(v){getDirForRootApp=v}],["getDirForLayoutTemplate",["getDirForLayoutTemplate"],function(v){getDirForLayoutTemplate=v}]]);_c0d‍.w("./async-utils",[["capture",["capture"],function(v){capture=v}],["readFileAsync",["readFileAsync"],function(v){readFileAsync=v}],["readdirAsync",["readdirAsync"],function(v){readdirAsync=v}],["statAsync",["statAsync"],function(v){statAsync=v}]]);_c0d‍.w("./common",[["forInLoopRegex",["forInLoopRegex"],function(v){forInLoopRegex=v}]]);_c0d‍.w("./handlebars-context",[["getHandlebarsContext",["getHandlebarsContext"],function(v){getHandlebarsContext=v}]]);_c0d‍.w("./process-data",[["processData",["processData"],function(v){processData=v}]]);_c0d‍.w("./add-remake-app-status",[["addRemakeAppStatusToPage",["addRemakeAppStatusToPage"],function(v){addRemakeAppStatusToPage=v}]]);_c0d‍.w("./get-partials",[["getPartialsAsInlinePartials",["getPartialsAsInlinePartials"],function(v){getPartialsAsInlinePartials=v}]]);_c0d‍.w("./get-global-data",[["getGlobalData",["getGlobalData"],function(v){getGlobalData=v}]]);_c0d‍.w("./get-html-with-unique-ids",[["getHtmlWithUniqueIds",["getHtmlWithUniqueIds"],function(v){getHtmlWithUniqueIds=v}]]);_c0d‍.w("../lib/remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);const parseUrl = require("parseurl");
const jsonfile = require("jsonfile");
       ...
       async function getRootAppsPageHtml() {
...
//   must be inside a layout, for...in helpers replaced, and compiled by handlebars
       async function getPageTemplate({ pageName, appName }) {
  ...
  if (pageTemplateString) {
    ...
    return Handlebars.compile(pageTemplateStringProcessed);
       ...
       async function getDataForPage({ req, res, appName, pageAuthor, itemId, pageName }) {
  ...
  return allData;
       ...
       function getPageHtml({ pageTemplate, data, appName, username, itemId, isPreviewing }) {
  ...
  return htmlWithUniqueIds;
       ...
       async function doesPageExist({ appName, pageName }) {
