let createUserData,getUserData,setUserData,showConsoleError,capture,getReservedWordInfo,sendEmail;_fe2‍.x([["initUserAccounts",()=>initUserAccounts]]);_fe2‍.w("./user-data",[["createUserData",["createUserData"],function(v){createUserData=v}],["getUserData",["getUserData"],function(v){getUserData=v}],["setUserData",["setUserData"],function(v){setUserData=v}]]);_fe2‍.w("../utils/console-utils",[["showConsoleError",["showConsoleError"],function(v){showConsoleError=v}]]);_fe2‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}]]);_fe2‍.w("../utils/get-reserved-word-info",[["getReservedWordInfo",["getReservedWordInfo"],function(v){getReservedWordInfo=v}]]);_fe2‍.w("../utils/send-email",[["sendEmail",["sendEmail"],function(v){sendEmail=v}]]);const passport = require("passport");
