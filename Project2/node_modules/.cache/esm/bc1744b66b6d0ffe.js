let createDataObjectFromElement,addDataFromElementToDataObject;_6b6‍.x([["getSaveData",()=>getSaveData]]);_6b6‍.w("./getSaveDataHelpers",[["createDataObjectFromElement",["createDataObjectFromElement"],function(v){createDataObjectFromElement=v}],["addDataFromElementToDataObject",["addDataFromElementToDataObject"],function(v){addDataFromElementToDataObject=v}]]);
...
// * key:example-key-name (for storing single pieces of data from the page as strings inside objects)
  ...
  function getDataFromDom(currentElement, parentData) {
    ...
    if (canElementDataBeParsed) {
      ...
      if (parentData) {
        parentData = _6b6‍.a("addDataFromElementToDataObject",addDataFromElementToDataObject)(currentElement, parentData);
      }

      // if there's no parent data, create new parent data
      if (!parentData && !rootData) {
        // create new parent and root data
        [parentData, rootData] = _6b6‍.a("createDataObjectFromElement",createDataObjectFromElement)(currentElement);
        ...
        parentData = _6b6‍.a("addDataFromElementToDataObject",addDataFromElementToDataObject)(currentElement, rootData);
      }
    }
