let getItemWithId,specialDeepExtend,setUserData,capture,RemakeStore;_8e7‍.x([["initApiSave",()=>initApiSave]]);_8e7‍.w("./get-item-with-id",[["getItemWithId",["getItemWithId"],function(v){getItemWithId=v}]]);_8e7‍.w("./special-deep-extend",[["specialDeepExtend",["specialDeepExtend"],function(v){specialDeepExtend=v}]]);_8e7‍.w("./user-data",[["setUserData",["setUserData"],function(v){setUserData=v}]]);_8e7‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}]]);_8e7‍.w("./remake-store",[["default",["RemakeStore"],function(v){RemakeStore=v}]]);const _ = require("lodash");
