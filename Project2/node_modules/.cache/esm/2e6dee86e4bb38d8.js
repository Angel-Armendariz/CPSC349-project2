let createUserData,getUserData,setUserData,showConsoleError,capture,getReservedWordInfo,sendEmail;_e4b‍.x([["initUserAccounts",()=>initUserAccounts]]);_e4b‍.w("./user-data",[["createUserData",["createUserData"],function(v){createUserData=v}],["getUserData",["getUserData"],function(v){getUserData=v}],["setUserData",["setUserData"],function(v){setUserData=v}]]);_e4b‍.w("../utils/console-utils",[["showConsoleError",["showConsoleError"],function(v){showConsoleError=v}]]);_e4b‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}]]);_e4b‍.w("../utils/get-reserved-word-info",[["getReservedWordInfo",["getReservedWordInfo"],function(v){getReservedWordInfo=v}]]);_e4b‍.w("../utils/send-email",[["sendEmail",["sendEmail"],function(v){sendEmail=v}]]);const passport = require("passport");
