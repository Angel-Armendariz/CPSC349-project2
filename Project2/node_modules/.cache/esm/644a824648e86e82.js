let $,getSaveData,ajaxPost,debounce,getAttributeValueAsArray,optionsData,callOnSaveCallbacks;_48e‍.x([["saveData",()=>saveData],["initSaveFunctions",()=>initSaveFunctions],["callSaveFunction",()=>callSaveFunction],["callSaveFunctionNextTick",()=>callSaveFunctionNextTick],["getSaveFuncInfo",()=>getSaveFuncInfo]]);_48e‍.w("../queryjs",[["$",["$"],function(v){$=v}]]);_48e‍.w("../get-save-data",[["getSaveData",["getSaveData"],function(v){getSaveData=v}]]);_48e‍.w("../hummingbird/lib/ajax",[["ajaxPost",["ajaxPost"],function(v){ajaxPost=v}]]);_48e‍.w("../hummingbird/lib/functions",[["debounce",["debounce"],function(v){debounce=v}]]);_48e‍.w("../parse-data-attributes",[["getAttributeValueAsArray",["getAttributeValueAsArray"],function(v){getAttributeValueAsArray=v}]]);_48e‍.w("./optionsData",[["default",["optionsData"],function(v){optionsData=v}]]);_48e‍.w("./callbacks",[["callOnSaveCallbacks",["callOnSaveCallbacks"],function(v){callOnSaveCallbacks=v}]]);
  ...
  _48e‍.a("ajaxPost",ajaxPost)("/save", { data, path, saveToId }, function (res) {
    // make live.js reload all resources in its cache when page is saved so it doesn't reload the page when user data changes -- and only reloads when dev edits a template
    window.liveJsResourcesLoaded = false;
    _48e‍.a("callOnSaveCallbacks",callOnSaveCallbacks)(res);
  });
}
...
let saveFunctionsLookup = {
  ...
  if (_48e‍.a("optionsData",optionsData).saveFunctions) {
    Object.assign(saveFunctionsLookup, _48e‍.a("optionsData",optionsData).saveFunctions);
  }
}
...
// all saves go through here
  ...
  let dataInsideSaveElement = _48e‍.a("getSaveData",getSaveData)(saveElement);
  ...
  if (_48e‍.a("optionsData",optionsData).logDataOnSave) {
    ...
    _48e‍.g.console.log(logDataOnSaveString, "Data:", dataInsideSaveElement);
  }
}
...
// used when clicking an element/button that might want to set data ahead of the save
  ...
  let args = _48e‍.a("getAttributeValueAsArray",getAttributeValueAsArray)(saveElement, dashCaseAttrName);
