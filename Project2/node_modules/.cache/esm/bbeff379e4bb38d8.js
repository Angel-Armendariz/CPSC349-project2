let showConsoleError,capture,mkdirpAsync,getBootstrapData,getDirForUserData;_e4b‍.x([["createUserData",()=>createUserData],["getUserData",()=>getUserData],["setUserData",()=>setUserData]]);_e4b‍.w("../utils/console-utils",[["showConsoleError",["showConsoleError"],function(v){showConsoleError=v}]]);_e4b‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}],["mkdirpAsync",["mkdirpAsync"],function(v){mkdirpAsync=v}]]);_e4b‍.w("../utils/get-bootstrap-data",[["getBootstrapData",["getBootstrapData"],function(v){getBootstrapData=v}]]);_e4b‍.w("../utils/directory-helpers",[["getDirForUserData",["getDirForUserData"],function(v){getDirForUserData=v}]]);const jsonfile = require("jsonfile");
...
// returns: {details, appData}
       async function createUserData({ appName, username, hash, email }) {
...
// returns: {username, type, data}
       async function setUserData({ appName, username, data, type }) {
