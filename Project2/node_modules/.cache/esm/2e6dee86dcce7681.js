let createUserData,getUserData,setUserData,showConsoleError,capture,getReservedWordInfo,sendEmail;_dcc‍.x([["initUserAccounts",()=>initUserAccounts]]);_dcc‍.w("./user-data",[["createUserData",["createUserData"],function(v){createUserData=v}],["getUserData",["getUserData"],function(v){getUserData=v}],["setUserData",["setUserData"],function(v){setUserData=v}]]);_dcc‍.w("../utils/console-utils",[["showConsoleError",["showConsoleError"],function(v){showConsoleError=v}]]);_dcc‍.w("../utils/async-utils",[["capture",["capture"],function(v){capture=v}]]);_dcc‍.w("../utils/get-reserved-word-info",[["getReservedWordInfo",["getReservedWordInfo"],function(v){getReservedWordInfo=v}]]);_dcc‍.w("../utils/send-email",[["sendEmail",["sendEmail"],function(v){sendEmail=v}]]);const passport = require("passport");
