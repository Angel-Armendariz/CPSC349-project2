let createDataObjectFromElement,addDataFromElementToDataObject;_58a‍.x([["getSaveData",()=>getSaveData]]);_58a‍.w("./getSaveDataHelpers",[["createDataObjectFromElement",["createDataObjectFromElement"],function(v){createDataObjectFromElement=v}],["addDataFromElementToDataObject",["addDataFromElementToDataObject"],function(v){addDataFromElementToDataObject=v}]]);
...
// * key:example-key-name (for storing single pieces of data from the page as strings inside objects)
  ...
  function getDataFromDom(currentElement, parentData) {
    ...
    if (canElementDataBeParsed) {
      ...
      if (parentData) {
        parentData = _58a‍.a("addDataFromElementToDataObject",addDataFromElementToDataObject)(currentElement, parentData);
      }

      // if there's no parent data, create new parent data
      if (!parentData && !rootData) {
        // create new parent and root data
        [parentData, rootData] = _58a‍.a("createDataObjectFromElement",createDataObjectFromElement)(currentElement);
        ...
        parentData = _58a‍.a("addDataFromElementToDataObject",addDataFromElementToDataObject)(currentElement, rootData);
      }
    }
